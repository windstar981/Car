...
(() => {
/*!***********************************************************!*\
  !*** ./platform/real-estate/src/resources/js/fengshui.js ***!
  \***********************************************************/
...
$(document).ready(function () {
  ...
  function solveDestiny(year) {
    year = year.toString();
    var first = Number(year[year.length - 2]);
    var second = Number(year[year.length - 1]);
  ...
  $('.btn-submit').click(function () {
    ...
    var life = resultDirection(solveDestiny(year));

...
(() => {
/*!****************************************************!*\
  !*** ./platform/interest/src/resources/js/plan.js ***!
  \****************************************************/
...
$(document).ready(function () {
  ...
  $('.btn-submit').click(function () {
    var expectedMoney = $('.expected-money').val().split(',').join('');
    var investmentMoney = $('.investment-money').val().split(',').join('');
    var time = $('.time').val();

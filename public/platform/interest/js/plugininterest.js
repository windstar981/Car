...
(() => {
/*!**************************************************************!*\
  !*** ./platform/interest/src/resources/js/plugininterest.js ***!
  \**************************************************************/
...
$(document).ready(function () {
  ...
  setOptionInterest(); //lua chon cach tinh lai
  ...
  function formatMoney(money) {
    ...
    for (var _i = money.length - 1; _i >= 0; _i--) {
      count++;

      if (count == 3) {
        money = insertCharacter(money, _i, ',');
        count = 0;
      }
    }

...
(() => {
/*!***********************************************************!*\
  !*** ./platform/interest/src/resources/js/compounding.js ***!
  \***********************************************************/
...
$(document).ready(function () {
  ...
  $('.btn-submit').click(function () {
    ...
    var moneyAdd = $('.add-money').val().split(',').join('');
    var time = $('.time').val();
    var interest = Number($('.interest').val()) / 100;
    ...
    var pMoney = Number($('.root-money').val().split(',').join(''));

    for (var i = 0; i <= time; i++) {
      lable_X.push('Năm ' + i);
      value_root.push(pMoney);
      html += '<tr>' + '<td>Năm ' + i + '</td>' + '<td class="text-right">' + formatMoney(value_root[i].toString()) + '</td>' + '<td class="text-right">' + formatMoney(value_future[i].toString()) + '</td>' + '</tr>';
      pMoney += Number($('.add-money').val().split(',').join('')) * 12;
    }

    var showMoney = value_future[value_future.length - 1];
    minY = value_future[0];

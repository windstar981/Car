...
(() => {
/*!**************************************************************!*\
  !*** ./platform/interest/src/resources/js/interestperson.js ***!
  \**************************************************************/
...
$(document).ready(function () {
  ...
  function showMoney() {
    ...
    var month = $('.value-month').val();
    month = month.split(' ')[0];
    console.log(month);
    var interest = $('.value-interest').val().split('%')[0];
  ...
  $('.money-range').change(function () {
    var money = Number($('.money-range').val()).toLocaleString('it-IT', {
      style: 'currency',
      currency: 'VND'
    });
  ...
  $('.value-money').keyup(function () {
    var money = $('.value-money').val().split('.').join('');
  ...
  $('.value-interest').keyup(function () {
    var interest = $('.value-interest').val();
  ...
  $('.month-range').change(function () {
    var month = $('.month-range').val() + ' tháng';
    $('.value-month').val(month);
    showMoney();
  });
  ...
  $('.value-money').blur(function () {
    var money = Number($('.value-money').val().split('.').join('')).toLocaleString('it-IT', {
      style: 'currency',
      currency: 'VND'
    });
    $('.value-money').val(money);
  ...
  $('.value-month').focusin(function () {
    var month = $('.value-month').val().split(' ')[0];
    $('.value-month').val(month);
  });
  $('.value-month').blur(function () {
    $('.month-range').val($('.value-month').val());
    var month = $('.value-month').val() + ' tháng';
    $('.value-month').val(month);
  });
  ...
  $('.value-interest').blur(function () {
    ...
    var interest = $('.value-interest').val() + '%/năm';
    $('.value-interest').val(interest);
  });
});
})();

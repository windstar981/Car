...
(() => {
/*!************************************************************!*\
  !*** ./platform/interest/src/resources/js/unemployment.js ***!
  \************************************************************/
...
$(document).ready(function () {
  ...
  var avgSalary = 0;
  var time = 0;
  var baseSalary = 1490000;
  var region = 1;
  var salaryService = 'Doanh nghiệp nhà nước';
  ...
  function getAvgSalaryChange() {
    return Number(Number(getMoney($('#month1').val())) + Number(getMoney($('#month2').val())) + Number(getMoney($('#month3').val())) + Number(getMoney($('#month4').val())) + Number(getMoney($('#month5').val())) + Number(getMoney($('#month6').val())) / 6);
  }
  ...
  $('.btn-submit').click(function () {
    ...
    var insuranceSalary = Math.ceil(avgSalary);
    var maxSalary = 20 * baseSalary;
    var salaryApply = insuranceSalary;

    if (salaryApply > maxSalary) {
      salaryApply = maxSalary;
    }

    var maxSupportSalary = 5 * baseSalary;
    var supportMonth = Math.floor(0.6 * salaryApply);
    var realSupportMonth = supportMonth;

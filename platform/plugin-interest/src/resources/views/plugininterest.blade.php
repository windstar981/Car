            ...
            <div class=" wrap-interest d-flex">
                <div class="wrap-input">
                    <div class="wrap-input-interest-detail mt-0 ">
                        ...
                        <input value="3,000" class="input-interest root-money" maxlength="18">
                    ...
                    <div class="wrap-input-interest-detail d-flex">
                        ...
                        <div class="wrap-input-money">
                            ...
                            <input id="LoanRatio" class="js__pay-input-percent re__input--sm re__icon-percent number-loan" value="" maxlength="18">

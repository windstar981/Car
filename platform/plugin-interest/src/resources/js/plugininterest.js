$(document).ready(function () {
    ...
    function setMoneyLoan() {
        moneyLoan = Number($('.root-money').val().split(',').join(''))*Number($('.rate-loan').val())/100;
        $('.number-loan').val(formatMoney(moneyLoan));
    }
    ...
    const export_button = document.getElementById('btn-export-excel');
